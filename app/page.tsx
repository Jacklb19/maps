    ...
    <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-amber-100 to-amber-200 font-sans py-6 sm:py-8 md:py-10">
      <main className="w-full max-w-xs sm:max-w-sm md:max-w-md mx-4 rounded-3xl bg-white shadow-2xl overflow-hidden">
        ...
        <div className="p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-5 md:space-y-6">
          ...
          <div className="bg-zinc-900 rounded-3xl p-4 sm:p-5 md:p-6 flex items-center gap-3 sm:gap-4">
            <div className="shrink-0 bg-white rounded-2xl p-2 sm:p-3">
              <Footprints className="h-6 w-6 sm:h-8 sm:w-8 text-zinc-900" />
            </div>
            <div className="flex-1 min-w-0">
              <h3 className="text-white font-semibold text-base sm:text-lg">Running</h3>
              <p className="text-gray-400 text-xs sm:text-sm">3000 meters per day</p>
          ...
          <div className="bg-gray-50 rounded-3xl p-4 sm:p-5 md:p-6 shadow-lg">
